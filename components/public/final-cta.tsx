    ...
    <section className="relative flex flex-1 flex-col bg-primary text-cream">
      <div className="mx-auto max-w-6xl px-4 py-32 w-full text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <TransitionLink href="/locations" className="inline-flex h-12 items-center justify-center rounded-lg bg-cream px-8 text-base font-medium text-primary hover:bg-cream/90">
            FIND THE TRUCK →
          </TransitionLink>
          <TransitionLink href="/catering" className="inline-flex h-12 items-center justify-center rounded-lg border border-cream px-8 text-base font-medium text-cream hover:bg-cream hover:text-primary">
            BOOK LOU →
          </TransitionLink>
        </div>
