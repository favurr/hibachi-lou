      ...
      <div className="mx-auto max-w-6xl px-4 py-24 w-full">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button type="submit" className="inline-flex h-12 items-center justify-center rounded-lg bg-primary px-8 text-base font-medium text-primary-foreground hover:bg-primary/90">Send Request</button>
          </form>
          ...
          <div className="space-y-6 rounded-xl border border-border p-6">
            ...
            <div>
              ...
              <a href="tel:+131****8567" className="mt-2 block font-medium text-foreground hover:text-primary">(313) 629-8567</a>
            </div>
            <div>
