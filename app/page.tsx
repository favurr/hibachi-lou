...
export default function HomePage() {
  ...
  return (
    <>
        ...
        <div className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-4 py-24 w-full">
            <div className="max-w-3xl space-y-8">
              <div className="space-y-4">
                <h2 className="font-heading text-5xl font-bold tracking-tight md:text-7xl leading-[0.88] text-cream">
                  IT&apos;S NOT<br />
                  JUST FOOD.<br />
                  IT&apos;S THE SHOW.
                </h2>
      ...
      <section id="find-lou" className="flex flex-1 flex-col bg-primary text-cream">
        <div className="mx-auto max-w-6xl px-4 py-24 w-full">
          <div className="max-w-3xl">
        ...
        <div className="mx-auto max-w-6xl px-4 py-24 w-full">
          ...
          <div className="mt-10 grid grid-cols-2 gap-3 md:grid-cols-6">
            <div className="col-span-2 row-span-2 overflow-hidden rounded-2xl border border-border">
              <Image src={GALLERY[0].src} alt={GALLERY[0].alt} width={1200} height={900} className="h-full w-full object-cover" />
            </div>
      ...
      <section className="relative flex flex-1 flex-col bg-primary text-cream">
        <div className="mx-auto max-w-6xl px-4 py-32 w-full text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link href="#find-lou" className="inline-flex h-12 items-center justify-center rounded-lg bg-cream px-8 text-base font-medium text-primary hover:bg-cream/90">
              FIND THE TRUCK →
            </Link>
